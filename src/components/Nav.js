    ...
    return (
        <nav className="flex flex-row text-white bg-black p-3 font-mono">
            ...
            <ul className="flex flex-grow flex-row justify-evenly">
                ...
                <Link to='online-shop/Shop' className="flex flex-row gap-1 items-center hover:scale-110">
                    <svg className="fill-white h-10" viewBox="0 0 24 24">
                ...
                <Link to='online-shop/Cart' className="flex flex-row gap-1 items-center hover:scale-110">
                    <svg className="fill-white h-10"  viewBox="0 0 24 24">
